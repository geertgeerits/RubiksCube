    ...
    internal class ClassSolveCubeCFOP
    {
        ...
        private static async Task<bool> SolveFirstTwoLayersAsync()
        {
            ...
            while (true)
            {
                ...
                // Step 3: How to solve the second layer of the Rubik's Cube (F2L)
                // Bring the edge piece from the top layer to the second layer (the cross is at the bottom)
                ...
                // Wrong orientation: Use the right algorithm to bring the piece to the top layer
